...
import UserInterface.SalesSpecialistWorkArea.SalesSpecialistWorkAreaContainerJPanel;
...
public class SalesSpecialistRole extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount userAccount, Organization organization, Enterprise enterprise, EcoSystem ecoSystem) {
        return new SalesSpecialistWorkAreaContainerJPanel(userAccount, organization, ecoSystem);
    }
