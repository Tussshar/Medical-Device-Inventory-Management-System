 ...
 * @author Tushar
 */
public class SignUpPersonDetailJDialog extends javax.swing.JDialog {
...
//    private int checkPhoneNumber = 0;
    ...
    public SignUpPersonDetailJDialog(JFrame mainJFrame, boolean modal, Organization organization, EcoSystem ecoSystem, ArrayList<Person> personDirectory, ArrayList<UserAccount> userAccountDirectory) {
        //super(parent, modal);
        initComponents();
...
//            count++;
//            errorMessage += "First Name should be less than or equal to 15 characters.\n";
//        }
//                if(lastName.length() > 15){
//            count++;
//            errorMessage += "Last Name should be less than or equal to 15 characters.\n";
//        }
//        if(apartment.length() > 15){
//            count++;
//            errorMessage += "Apartment should be less than or equal to 15 characters.\n";
//        }
        try {
        ...
        if(!firstName.matches("[a-zA-Z]+")){
            count++;
            errorMessage += "Invalid Character in First Name, First Name can accept only alphabets\n";
        }
        
        if(!lastName.matches("[a-zA-Z]+")){
            count++;
            errorMessage += "Invalid Character in Last Name, Last Name can accept only alphabets\n";
        }
        
        if(!city.matches("[a-zA-Z]+")){
            count++;
            errorMessage += "Invalid Character in City Name, City Name can accept only alphabets\n";
        }
        
        if(!state.matches("[a-zA-Z]+")){
            count++;
            errorMessage += "Invalid Character in State Name, State Name can accept only alphabets\n";
        }
        if (count == 0) {
            try {
...
//            if (checkDuplicateEmailAddress == 0) {
                person = ecoSystem.getPersonDirectory().createAndAddPerson(firstName, lastName, streetName, apartment, city, state, zipCode, phoneNumber, emailAddress, organization);
                personDirectory.add(person);
                SignUpUserAccountJDialog suajd = new SignUpUserAccountJDialog(mainJFrame, true, organization, ecoSystem, personDirectory, userAccountDirectory, emailAddress, firstName);
                suajd.setVisible(true);
                dispose();
//            } else {
...
//            }
    ...
    public void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignUpPersonDetailJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SignUpPersonDetailJDialog dialog = new SignUpPersonDetailJDialog(mainJFrame, true, organization, ecoSystem, personDirectory, userAccountDirectory);
