 ...
 * @author Tushar
 */
public class HospitalEnterpriseAdminWorkAreaContainerJPanel extends javax.swing.JPanel {

    /**
     * Creates new form HospitalEnterpriseAdminWorkAreaContainerJPanel
     */

    private EcoSystem ecoSystem;
    public HospitalEnterpriseAdminWorkAreaContainerJPanel(UserAccount userAccount, Enterprise enterprise, EcoSystem ecoSystem) {
        initComponents();

        this.ecoSystem = ecoSystem;
        
        HospitalEnterpriseAdminWorkAreaJPanel heawajp = new HospitalEnterpriseAdminWorkAreaJPanel(userProcessContainer, userAccount, enterprise, ecoSystem);
        userProcessContainer.add("Hospital Enterprise Admin Work Area JPanel", heawajp);
