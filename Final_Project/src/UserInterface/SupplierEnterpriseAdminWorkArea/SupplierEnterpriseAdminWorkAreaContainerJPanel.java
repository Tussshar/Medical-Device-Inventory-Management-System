 ...
 * @author Tushar
 */
public class SupplierEnterpriseAdminWorkAreaContainerJPanel extends javax.swing.JPanel {

    /**
     * Creates new form SupplierEnterpriseAdminWorkAreaContainerJPanel
     */
    ...
    public SupplierEnterpriseAdminWorkAreaContainerJPanel(EcoSystem ecoSystem, UserAccount userAccount, Organization organization, Enterprise enterprise,ArrayList<Person> personDirectory, ArrayList<UserAccount> userAccountDirectory) {
        initComponents();
        ...
        SupplierEnterpriseAdminWorkAreaJPanel sawajp = new SupplierEnterpriseAdminWorkAreaJPanel(userProcessContainer, organization, ecoSystem, userAccount, enterprise, personDirectory, userAccountDirectory);
        userProcessContainer.add("Supplier Admin Work Area JPanel",sawajp);
